...
**Environments:** Site URLs live in [`environments.md`](environments.md), including Control Tower landlord PRODUCTION vs backend/tenant PRODUCTION. PRODUCTION HARD RULE (Angelo 2026-09-18): bots may ONLY observe / peek either PROD host when Angelo explicitly asks — NO modifying.
