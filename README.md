...
**Environments:** Site URLs live in [`environments.md`](environments.md), including Control Tower landlord PRODUCTION vs backend/tenant PRODUCTION. Never use PRODUCTION hosts for feature preview.
